...
const Show = require("../modles/showModel");
const Theatre = require("../modles/theatreModel");
// add theatre
router.post("/add-theatre", authMiddleware, async (req, res) => {
  try {
    ...
    res.send({
      success: true,
      message: "theatre add successfully",
    });
  } catch (error) {
    res.send({
      success: false,
...
router.get("/get-all-theatres", authMiddleware, async (req, res) => {
  try {
    ...
    res.send({
      success: true,
      message: "Theatres details fetched successfully",
      data: theatres,
    });
  } catch (error) {
    res.send({
