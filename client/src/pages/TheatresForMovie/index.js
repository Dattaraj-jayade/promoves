      ...
      <div>
        ...
        <div className="flex justify-between items-center mb-2">
          <div>
            ...
            <h1 className="text-sm text-white">Genre : {movie.genre}</h1>
          </div>

          <div>
            <h1 className="text-sm text-white">Select Date</h1>
            <input
              type="date"
        ...
        {/* movie theatres */}
        <div className="mt-1">
          <h1 className="text-xl uppercase text-white">Theatres</h1>
        </div>
